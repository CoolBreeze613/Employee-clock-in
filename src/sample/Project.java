...
public class Project {
    ...
    public void clockIn() {
        ...
        alert.setTitle("Clocked in");
        alert.setHeaderText(null);
        alert.setContentText("You have successfully clocked in at: " + dateFormat.format(clockInTime));
        alert.showAndWait();

        clockinbut.setVisible(false);
    ...
    public void clockOut() {
        ...
        long difference = clockOutTime.getTime() - clockInTime.getTime();
        System.out.println(difference/1000); //2014/08/06 15:59:48
        long timeout = difference/1000;


        System.out.println(((difference/1000)/60)/60);
        double timeElapsed = ((((difference/1000)/60)/60));

        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Clocked out");
        alert.setHeaderText(null);
        alert.setContentText("You have successfully clocked out at: " + dateFormat.format(clockOutTime));
        alert.showAndWait();
        ...
        try {
            ...
            PreparedStatement pstmt = connection.prepareStatement("INSERT INTO `clock`(fk_employee_id, clock_in_time, approval) VALUE ('"+main.employeeId+"',"+timeout+", 'P')");
            pstmt.executeUpdate();
